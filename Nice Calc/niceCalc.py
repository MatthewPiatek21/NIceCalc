...
def button_equal():
    ...
    if math == "addition":
        ...
        if f_num + int(second_number) == 69:
            e.insert(3, str(funny) + (current))
...
button_0 = Button(root, text="0", padx=195, pady=20, command=lambda: button_click(0))

button_add = Button(root, text="+", padx=38, pady=20, command=button_add)
button_equal = Button(root, text="=", padx=40, pady=20, command=button_equal)
button_clear = Button(root, text="AC", padx=191, pady=20, command=button_clear)
